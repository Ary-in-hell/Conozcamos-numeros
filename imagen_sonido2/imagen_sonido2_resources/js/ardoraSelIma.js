...
newHtml=newHtml+"<p>";if (quest[indexGame-1][1].localeCompare("X")==0){newHtml=newHtml+"<img id='bQuestSound' src='"+dirMedia+"music-therapy.png'/>"}
...
if (partialCo){score=score+scoreInc;timeAct=timeAct+timeBon;successes++;in_act++;if (in_act>quest.length-1){showMessage("Ok");}else{indexGame=actorder[in_act];paintBoard();}}
