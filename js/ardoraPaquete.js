...
taboaContidos[0]=new act("Pantalla principal","Pantalla principal","","<object width='100%' height='600' type='text/html' data='Pantalla_inicial/Pantalla_inicial.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("Nivel 1","Nivel 1","","<object width='100%' height='600' type='text/html' data='Panorama1/Panorama1.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("Buscar la pareja nivel 1","Buscar la pareja nivel 1","","<object width='100%' height='600' type='text/html' data='PAREJA_lvl_1/PAREJA_lvl_1.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("Escucha y selecciona nivel 1","Escucha y selecciona nivel 1","","<object width='100%' height='600' type='text/html' data='imagensonido1/imagensonido1.htm'></object>",false,"",true,false,false);
taboaContidos[4]=new act("Asociar número nivel 1","Asociar número nivel 1","","<object width='100%' height='600' type='text/html' data='Asocie_1/Asocie_1.htm'></object>",false,"",true,false,false);
taboaContidos[5]=new act("Nivel 2","Nivel 2","","<object width='100%' height='600' type='text/html' data='panorama2/panorama2.htm'></object>",false,"",true,false,false);
taboaContidos[6]=new act("Buscar la pareja nivel 2","Buscar la pareja nivel 2","","<object width='100%' height='600' type='text/html' data='PAREJA_lvl_2/PAREJA_lvl_2.htm'></object>",false,"",true,false,false);
taboaContidos[7]=new act("Escucha y selecciona nivel 2","Escucha y selecciona nivel 2","","<object width='100%' height='600' type='text/html' data='imagen_sonido2/imagen_sonido2.htm'></object>",false,"",true,false,false);
taboaContidos[8]=new act("Asociar número nivel 2","Asociar número nivel 2","","<object width='100%' height='600' type='text/html' data='Asocie_2/Asocie_2.htm'></object>",false,"",true,false,false);
taboaContidos[9]=new act("Evaluación","Evaluación","","<object width='100%' height='600' type='text/html' data='Evaluacion/Evaluacion.htm'></object>",false,"",false,false,false);
